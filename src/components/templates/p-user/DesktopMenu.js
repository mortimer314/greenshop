  ...
  return (
    <div className='sticky top-0 pl-6 py-6'>
      ...
      <div className="flex flex-col gap-y-2.5">
        ...
        <Link className={`flex items-center gap-x-3 h-[58px] px-4 rounded-lg transition-all duration-300 ${(shortName === "account-details" || asPath === "/p-user") ? "text-primary bg-primary-light" : ""}`} href='/p-user/account-details' >
