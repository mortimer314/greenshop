...
function UserPanelMenu() {
    ...
    return (
        <div className='flex flex-col justify-between h-[calc(100vh-158px)] container py-6 sm:hidden'>
            ...
            <main>
                ...
                <div className="flex flex-col gap-y-2.5">
                    ...
                    <Link className="flex items-center gap-x-3 h-[58px] px-4 rounded-lg transition-all duration-300 text-gray-plus-700" href='/p-user/account-details' >
                    ...
                    <Link className="flex items-center gap-x-3 h-[58px] px-4 rounded-lg transition-all duration-300 text-gray-plus-700" href='/p-user/cunsolting' >
                    ...
                    <Link className="flex items-center gap-x-3 h-[58px] px-4 rounded-lg transition-all duration-300 text-gray-plus-700" href='/p-user/messages' >
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <button className="flex items-center gap-x-3 w-full h-[58px] mb-6  px-4 rounded-lg bg-red-50 text-red-500">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
