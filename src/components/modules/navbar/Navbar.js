...
function Navbar() {
    ...
    return (
        <nav className=''>
            <div className="container relative z-10  pt-3 ">
                ...
                {/* mobile menu */}
                <div className={`${showMobileMenu ? "h-screen pt-4" : "h-0"} inset-0 lg:hidden  flex justify-between flex-row-reverse transition-all  duration-500 container fixed z-50 top-0  bg-white overflow-hidden`}>
                ...
                <div className="hidden sm:block border-b border-gray-plus-400 mb-3"></div>
            </div>
            <div className="border-b sm:hidden border-gray-plus-400 mb-3"></div>
        </nav>
    )
}
